...
public class PublisherController {
    ...
    public String getIndex(Model model) {
        ...
        List<Configs> configs = mySQLConfigsRepository.findByCnameAndCkeyLikeOrderByCkeyAsc("publisher", "from%");
        ...
        List<Configs> configs1 = mySQLConfigsRepository.findByCnameAndCkeyLikeOrderByCkeyAsc("publisher", "to%");
